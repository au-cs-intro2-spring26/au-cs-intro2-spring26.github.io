...
| Book                                                    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|---------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![OOP Python Cover](img/ObjectOrientedPythonCover.jpg) | **Title**: Object-Oriented Python: Master OOP by Building Games and GUIs (OOP)<br> **Author**: Irv Kalb <br> [Free from AU on O'Reilly Safari](https://learning.oreilly.com/library/view/object-oriented-python/9781098129842/)<br> abbreviation: **OOP** on the [Schedule](/schedule)                                                                                                        |
| ![PythonDS Cover](img/pythonds3.jpg)                    | **Title**: Problem Solving with Algorithms and Data Structures using Python v3 (DS)<br> **Author**: Brad Miller and David Ranum, Luther College <br> Available for free from Runestone Academy with free account. [Third Edition](https://runestone.academy/ns/books/published/pythonds3/index.html). <br> abbreviation: **DS** on the [Schedule](/schedule)                                                                                          |
| ![HTTLACS Cover](img/RAIcon.png)                        | **Title**: How to Think Like a Computer Scientist - Interactive Edition (HTTLACS) <br> **Author**: Brad Miller, David Ranum, Jeffrey Elkner, Peter Wentworth, Allen B. Downey, Chris Meyers, and Dario Mitchell <br> Available for free from Runestone Academy with free account. [Interactive Edition](https://runestone.academy/ns/books/published/thinkcspy/index.html?mode=browsing). <br> abbreviation: **HTTLACS** on the [Schedule](/schedule) |
